...
namespace LootMod
{
    ...
    /// </summary>
    public class LootModMain : ModMain
	{
        ...
        public new LootModConfig Config => (LootModConfig)base.Config;
		...
		public override void OnModEnabled() {
			...
			ModHandler mh = new ModHandler(this, harmony);
			mh.ApplyChanges();
        }
