...
namespace LootMod
{
	...
	public class LootModTacInstanceData
	{
	...
	/// </summary>
	public class LootModTactical : ModTactical
	{
		/// <summary>
		...
		public override void OnTacticalStart() {
			...
			LootModMain main = (LootModMain)Main;
		}
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			LootModTacInstanceData data = (LootModTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new LootModTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
