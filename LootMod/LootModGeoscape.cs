...
namespace LootMod
{
	...
	public class LootModGSInstanceData
	{
	...
	/// </summary>
	public class LootModGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new LootModGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			LootModGSInstanceData data = (LootModGSInstanceData)instanceData;
		}
