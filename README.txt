...
- LootModConfig.cs: Example of ModConfig for custom mod settings;
- LootModGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- LootModMain.cs: Main mod class, recieves mod management and general events;
- LootModTactical.cs: Example of ModTactical for modifying tactical level;
